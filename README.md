...
This project presents a method for analyzing gene alignment results to screen out optimal genes.(这个项目描述了一种对基因比对结果分析，用以筛选出最佳基因的方法。)
# LS-BSR结果的处理
...
![pic_1](./demo/pics/pic_1.png)

### **2.LS-BSR的结果解读：**

![pic_2](./demo/pics/pic_2.png)
...
![pic_7](./demo/pics/pic_7.png)

### ==**3.数据的计算分析**==

#### 3.1 “交叉现象”

![pic_3](./demo/pics/pic_3.png)
...
![pic_4](./demo/pics/pic_4.png)

![pic_5](./demo/pics/pic_5.png)
...
![pic_6](./demo/pics/pic_6.png)

### 4.散点图的绘制

**具体意义：在参加比对的基因中，展示出选出的具有代表性的三个或一个基因**

![Salmonella](./demo/pics/Salmonella.png)
...
![Salmonella_gene2177](./demo/pics/Salmonella_gene2177.png)
